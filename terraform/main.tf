...
# --- S3 bucket: fully private, CloudFront reaches it only via OAC ---
...
resource "aws_s3_bucket_website_configuration" "site" {
  ...
  error_document {
    key = "index.html" # SPA fallback — client-side routing handles the rest
  }
}

# --- CloudFront: Origin Access Control, no public bucket access needed ---
